        ...
        <?php foreach($ponentes as $ponente) : ?>
            <div <?php aos_animacion(); ?> class="speaker">
                ...
                <div class="speakers__informacion">
                    ...
                    <nav class="speakers--sociales">
                        <?php $redes = json_decode($ponente->redes); ?>

                        <?php if(!empty($redes->facebook)) : ?>
                            <a class="speakers--sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->facebook; ?>">
                                <span class="speakers--sociales__ocultar">Facebook</span>
                            </a> 
                        <?php endif; ?>
                        
                        <?php if(!empty($redes->twitter)) : ?>
                            <a class="speakers--sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->twitter; ?>">
                                <span class="speakers--sociales__ocultar">Twitter</span>
                            </a>
                        <?php endif; ?>

                        <?php if(!empty($redes->youtube)) : ?>
                            <a class="speakers--sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->youtube; ?>">
                                <span class="speakers--sociales__ocultar">YouTube</span>
                            </a> 
                        <?php endif; ?>
                        
                        <?php if(!empty($redes->instagram)) : ?>
                            <a class="speakers--sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->instagram; ?>">
                                <span class="speakers--sociales__ocultar">Instagram</span>
                            </a> 
                        <?php endif; ?>
                        
                        <?php if(!empty($redes->tiktok)) : ?>
                            <a class="speakers--sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->tiktok; ?>">
                                <span class="speakers--sociales__ocultar">Tiktok</span>
                            </a> 
                        <?php endif; ?>
                        
                        <?php if(!empty($redes->github)) : ?>
                            <a class="speakers--sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->github; ?>">
                                <span class="speakers--sociales__ocultar">Github</span>
                            </a>
                        <?php endif; ?>
                    </nav>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Elige el que más te convenga</p>
